        ...
        <!----Add Category form starts---->
           ...
           <form action="" method="POST" enctype="multipart/form-data">
             <table class="tbl-30">
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Result" class="btn-secondary">
                    </td>
                </tr>
             </table>
           ...
           <?php
             ...
             if(isset($_POST['submit']))
             {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    //Rename the image
                    $image_name = "result_".rand(000,999).'.'.$ext;// e.g alumni_image_814.jpg
                    ...
                    if($upload==false)
                    {
                        ...
                        header('location:'.SITEURL.'admin/add-result.php');
                        //stop the process
                        die();
                    }
                 }
                ...
                if($res==true)
                {
                    ...
                    $_SESSION['add'] = "<div class='success'>Result Added Successfully</div>";
                ...
                else
                {
                    ...
                    $_SESSION['add'] = "<div class='error'>Failed to Add Result</div>";
                    //redirect to manage category page
                    header('location:'.SITEURL.'admin/manage-result.php');
                }
             }
