...
<!-- First nevigation -->
    ...
    <div class="container">
    <div class="row">
      <div class="col-8 mx-auto mt-5 mb-3">
        <div class="card border-success">
          <div class="card-body">
            <div class="text-center">
              <img src="../image/accept.png" alt="Submission Success" width="150" height="150">
            </div>
            <h1 class="text-center text-success mt-3 mb-4" style="font-size: 45px; font-weight: bold;">Form Submission Successful</h1>
            <p class="text-muted text-justify">
              Follow the below steps for further procedure:
              <ol>
                <li>Please contact the BUBT Admission Office for further procedure.</li>
                <li>Please deposit the admission fee to confirm admission. The admission fee for the CSE department is 20,000 BDT.</li>
              </ol>
            </p>
          </div>
        </div>
