...
<!-- First nevigation -->
 ...
 <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #FFFFFF; height: 120px;">
    ...
    <div class="container-fluid p-3 " style="background-color: #38B6FF; height: 225px;">
            ...
            <div class="row mt-0">
                <div class="col">
                <h5 class="text-center mb-2 font-weight-bold text-light notice_txt"><i class="bi bi-caret-right-fill"></i> Class Routine</h5>
                
                </div>
                <div class="col text-center mb-5">
                    <img src="../image/routine.png" alt="Notice Image" height="180px" width="220px" >
                </div>
            </div>  
    </div>
    ...
    <div class="container mt-3" style="height:auto;">
        <div class="row">
            <div class="col-md-4 align-items-center justify-content-left">
                ...
                <div class="card " style="font-size: 18px;  margin-top: 20px; font-weight: 600; border: 2px solid #b2bec3; color: #38B6FF; ">
                    <div class="card-body">
                        <h5 class="font-weight-bold d-flex align-items-center justify-content-left" style="color: #ff4d4d; font-size: 30px; margin-left: 0px; margin-bottom: 15px">
                            <i class="bi bi-search"> Search For Class Routine</i>
                        </h5>
                        <form method="POST" action="">
                            <div class="form-group">
                                <label for="department" class="text-muted">Department:</label>
                                <select type="inputState" class="form-control input_design" name="department" value="<?php echo $ps; ?>">
                            ...
                            <div class="form-group">
                                <label for="intake" class="text-muted">Intake:</label>
                                <select type="inputState" class="form-control input_design" name="intake" value="<?php echo $ps; ?>">
                                    <option selected></option>
                                    <option>44</option>
                                    <option>20</option>
                                    <option>22</option>
                            ...
                            <div class="form-group">
                                ...
                                <select type="inputState" class="form-control input_design" name="section" value="<?php echo $ps; ?>">
                                    <option selected></option>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3 </option>
                            ...
                            <button type="submit" class="btn btn-block text-light" style=" background-color: #38B6FF; font-weight: bold ;" name="search">Search</button>
                        </form>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <h3 class="font-weight-semibold d-flex align-items-center justify-content-left text-dark text-muted" style="font-size: 25px;  margin-top: 20px; font-weight: 600;">
                    <i class="bi bi-caret-right-fill"></i>Available class routines for current semester
                </h3> 
                <br>
                <form action="routine_view.php" method="GET">
                <table class="table" >
                    <thead>
                        <tr>
                            <th>Department</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $query = "SELECT * FROM routine WHERE 1";
