...
<body>
    ...
    <div class="container-fluid p-3 " style="background-color: #38B6FF; height: 225px;">   
            <div class="row mt-0">
                ...
                <h5 class="text-center mb-0 font-weight-semibold text-light " style=" margin-left:73px;"> Faculty Members of CSE Dept.</h5>
                </div>
    ...
    <div class="card text-center">
        <div class="card-header">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="lab_assistent.php">Lab Assistent</a>
            </li>
            <li class="nav-item">
