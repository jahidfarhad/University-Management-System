...
<!-- First nevigation -->
    ...
    <div class="container-fluid p-3 " style="background-color: #38B6FF; height: 225px;">
            ...
            <div class="row mt-0">
                <div class="col">
                <h5 class="text-center mb-0 font-weight-bold text-light notice_txt"><i class="bi bi-caret-right-fill"></i> Notice Board</h5>
                </div>
                <div class="col text-center mb-5">
                    <img src="../image/v228-wit-49a-job58_prev_ui.png" alt="Notice Image" height="215px" width="190px" >
                </div>
            </div>  
    </div>
    ...
    <div class="container mt-5 mb-2">
        <h3 class="font-weight-bold" style="color: #38B6FF;" >All Recent Notice :</h3><br>
        <?php
        ...
        ?>
            <div class="card bg-transparent custom-border rounded mb-4" style="max-height: 300px;">
            <div class="row no-gutters">
            
            <div class="col-3 d-flex align-items-center justify-content-center">
                <img src="../image/push-pin.png" class="card-img square-image" alt="Noticeboard icon">
            </div>
            <div class="col-8">
                <div class="card-body">
                <h5 class="card-title"><?php echo $row["content_title"]; ?></h5>
                <p class="card-text">
                    <small class="text-muted"><i class="bi bi-calendar-event"></i> <?php echo $row["date"]; ?></small>
                </p>
                <p class="card-text">
                    <?php
                    $content = $row["content"];
            ...
            <div class="card-footer d-flex justify-content-end bg-light" style="padding: 0.5rem;">
            <button class="btn btn-danger btn-sm noticebtn" data-id="<?php echo $row['num'];?>" data-toggle="modal" data-target="#noticemodal">
