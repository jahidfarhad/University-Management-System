...
<body>
    ...
    <div class="container-fluid p-3 " style="background-color: #38B6FF; height: 225px;">   
            <div class="row mt-0">
                ...
                <h5 class="text-center mb-0 font-weight-semibold text-light " style=" margin-left:73px;"> IT Officers of CSE Dept.</h5>
                </div>
    ...
    <div class="card text-center">
        <div class="card-header">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="lab_assistent.php">Lab Assistant</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="it_officers.php" style="color:#38B6FF; font-weight:500;">IT Officers</a>
            </li>
            </ul>
        </div>
        <div class="card-body">
            ...
            <div class="row mt-4 flex-fill">
                <?php
                    ...
                    $stmt = $conn->prepare("SELECT * FROM people WHERE catagory='it'");
                    $stmt->execute();
