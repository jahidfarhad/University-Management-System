...
<body>
    ...
    <!-- Blog head -->
    <div class="container-fluid p-3 " style="background-color: #a29bfe; height: 180px;">
    <div class="row mt-0">
                <div class="col">
                ...
                <div class="col text-center mb-5">
                    <img src="../image/blog_bg.png" alt="Notice Image" height="150px" width="190px" >
                </div>
            </div>  
    </div>
            ...
            <div class="row" style="height:auto;">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    <?php
                        ...
                        if(isset($_GET['id'])){
                            $pid =$_GET['id'];
                            $query = "SELECT * FROM blog WHERE bno=$pid";
                            $getdata = mysqli_query($conn,$query);
                            
                            while($rx=mysqli_fetch_assoc($getdata)){   
                    ?>
                        <h5 class="text-left mb-4 font-weight-bold title_txt"><i class="bi bi-caret-right-fill"></i>
                            <?php echo $rx["blog_title"]; ?>
                        </h5>

                        <h5 class="text-left text-muted mb-2 font-weight-semibold">
                          Author:  <?php echo $rx["author_name"]; ?>
                        </h5>

                        <h6 class="text-left text-muted mb-2 mt-2 font-weight-semibold">Date: 
                            <?php echo $rx["date"]; ?>
                        </h6><br>

                        <img src="../blog_image/<?php echo $rx["image"]; ?>" class="card-img-top img-fluid" alt="">
                        <br><br>

                        <h6 class="text-left  mb-2 mt-2 font-weight-semibold blog-content">
                            <?php echo $rx["blog_content"]; ?>
                        </h6><br>
                ...
                <div class="col-4 text-center">
                    <h4 class="font-weight-semibold d-flex align-items-center justify-content-center text-dark">More Blogs</h4><br>
                    <div class="d-flex flex-column align-items-center">
                        ...
                        ?>
                            <div class="card small-card flex-fill custom-border mb-4">
                                <img src="../blog_image/<?php echo $row["image"]; ?>" class="card-img-top img-fluid" alt="">   
                                <div class="card-body d-flex flex-column">
                                    <h6 class="font-weight-semibold mb-2">
                                        <a href="blog_view.php?id=<?php echo $row['bno'];?>" class="text-dark" data-abc="true"><?php echo $row["blog_title"]; ?></a>
                                    </h6> 
                                </div>
                            </div>
                        <?php endwhile; ?>
